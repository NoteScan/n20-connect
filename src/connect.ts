import { UnisatConnector, ChainBowConnector, NoteMarketConnector } from './connectors';
import {
  Balance,
...
class BtcWalletConnect {
  ...
  constructor({
    ...
    this.connectors = [
      ...
      {
        id: 'chainbow',
        instance: new ChainBowConnector(this.network),
        installed: !!window.chainbow,
      },
      {
        id: 'notemarket',
        instance: new NoteMarketConnector(this.network),
        installed: !!window.NOTEMarketWallet,
      },
    ];
  ...
  on(
    ...
    } else if (this.connector instanceof ChainBowConnector) {
        this.connector.on(event as 'networkChanged' | 'accountsChanged', handler);
    } else if (this.connector instanceof NoteMarketConnector) {
        this.connector.on(event as 'networkChanged' | 'accountsChanged', handler);
    }
  }
  removeListener(
